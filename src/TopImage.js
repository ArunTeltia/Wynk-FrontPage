...
export default class TopImage extends Component {
  constructor() {
    ...
    this.state = {
      currentImage: 0,
      slide: [
        "https://img.wynk.in/unsafe/720x251/filters:no_upscale():format(webp)/http://s3.ap-south-1.amazonaws.com/discovery-prod-arsenal/arsenal/artworks/5f64661778475c44322a6526/BANNER_7435068331017221.png",
